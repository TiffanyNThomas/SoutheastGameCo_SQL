...
CREATE TABLE `orderline_t` (
  ...
  KEY `orderline_FK2` (`itemID`),
  CONSTRAINT `orderline_FK1` FOREIGN KEY (`orderNumber`) REFERENCES `order_t` (`orderNumber`),
  CONSTRAINT `orderline_FK2` FOREIGN KEY (`itemID`) REFERENCES `game_t` (`itemID`)
