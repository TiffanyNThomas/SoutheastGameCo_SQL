...
CREATE TABLE `store_t` (
  ...
  KEY `store_FK` (`managerID`),
  KEY `store_FK2` (`locationID`),
  CONSTRAINT `store_FK` FOREIGN KEY (`managerID`) REFERENCES `employee_t` (`employeeID`),
  CONSTRAINT `store_FK2` FOREIGN KEY (`locationID`) REFERENCES `location_t` (`locationID`)
