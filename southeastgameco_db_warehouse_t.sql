...
CREATE TABLE `warehouse_t` (
  ...
  KEY `warehouse_FK` (`managerID`),
  KEY `warehouse_FK2` (`locationID`),
  CONSTRAINT `warehouse_FK` FOREIGN KEY (`managerID`) REFERENCES `employee_t` (`employeeID`),
  CONSTRAINT `warehouse_FK2` FOREIGN KEY (`locationID`) REFERENCES `location_t` (`locationID`)
...
LOCK TABLES `warehouse_t` WRITE;
/*!40000 ALTER TABLE `warehouse_t` DISABLE KEYS */;
INSERT INTO `warehouse_t` VALUES (701,22,103);
/*!40000 ALTER TABLE `warehouse_t` ENABLE KEYS */;
UNLOCK TABLES;
